...
public class SixBands extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    private Spinner comboBox1, comboBox2, comboBox3,comboBox4, comboBox5, comboBox6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_six_bands);
        ...
        comboBox6 = findViewById(R.id.comboBox6);
        ...
        comboBox4.setAdapter(adapter1);
        comboBox5.setAdapter(adapter2);
        comboBox6.setAdapter(adapter2);
    ...
    public void toProcessInput(View v) {
        String output = pic.processInputSixBands(comboBox1.getSelectedItemPosition(), comboBox2.getSelectedItemPosition(), comboBox3.getSelectedItemPosition(), comboBox4.getSelectedItemPosition(), comboBox5.getSelectedItemPosition(), comboBox6.getSelectedItemPosition());
